...
class ApiService {
  ...
  Future<http.Response> signup(String username, String email, String password, Map<String,String> vehicleData, String phoneNum ) async {
...
Future<List<Map<String, dynamic>>> getNearbyParkingSpots() async {
  try {
    final response = await http.get(Uri.parse('$baseUrl/property-image/get-all-property'));
