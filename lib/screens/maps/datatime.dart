  ...
  Future<Map<String, dynamic>?> fetchParkingSpotById(int parkingId) async {
    try {
      final response = await http.get(Uri.parse(
          'https://backendspringboot2-production.up.railway.app/api/parking-spots/$parkingId'));
                            ...
                            onPressed: () async {
                              try {
                                ...
                                if (parkingSpot != null) {
                                  ...
                                  print(
                                      "No parking spot found with ID: $parkingId");
                                }
                              } catch (e) {
