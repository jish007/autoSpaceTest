...
class VehicleForm extends StatefulWidget {
  ...
  const VehicleForm({super.key, required this.userMail});
 ...
 // Create an instance of ApiService
  Future<void> addVehicle() async {
    ...
    try {
      ...
      String? userIdString =
          prefs.getString('user_id'); // Ensure it's stored as String
      ...
      final response = await apiService.addVehicle(
          vehicleNumber, brand, model, color, userId);
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
              builder: (context) => MainScreen(userMail: widget.userMail,)), // Change to your screen
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color:
                          const Color.fromARGB(255, 151, 8, 8).withOpacity(0.1),
                      spreadRadius: 1,
                      blurRadius: 5,
                    ),
                  ],
